...
public class Constants {
	...
	public static final int FIFTEEN_SEC = 15;
	...
	public static final int GEOCODER_RESULT = 3000;// 地理编码或逆地理编码成果
	public static final int GEOCODER_NO_RESULT = 3001;// 地理编码或逆地理编码没有数据

	public static final int POISEARCH = 4000;// poi搜索到结果
	public static final int POISEARCH_NO_RESULT = 4001;// poi没有搜索到结果
	public static final int POISEARCH_NEXT = 5000;// poi搜索下一站
